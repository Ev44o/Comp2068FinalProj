...
<?php
	...
	$question5 = $_POST['question5'];
			...
			if (empty($_POST['name']))
			{
				echo '<div class="center-title">Please Enter A Title</div>';
				$formOK = false;
			}
			if (empty($_POST['question1']))
			{
				echo '<div class="center-title">Please Enter Question 1</div>';
				$formOK = false;
			}
			if (empty($_POST['question2']))
			{
				echo '<div class="center-title">Please Enter Question 2</div>';
				$formOK = false;
			}
			if (empty($_POST['question3']))
			{
				echo '<div class="center-title">Please Enter Question 3</div>';
				$formOK = false;
			}		
			if (empty($_POST['question4']))
			{
				echo '<div class="center-title">Please Enter Question 4</div>';
				$formOK = false;
			}				
			if (empty($_POST['question5']))
			{
				echo '<div class="center-title">Please Enter Question 5</div>';
				$formOK = false;
			}	
