...
<?php 
			...
			{
				echo '<div class="center-title">Please Answer Question 1</div>';
				$formOK = false;
			}
			if (empty($_POST['answer2']))
			{
				echo '<div class="center-title">Please Answer Question 2</div>';
				$formOK = false;
			}
			if (empty($_POST['answer3']))
			{
				echo '<div class="center-title">Please Answer Question 3</div>';
				$formOK = false;
			}		
			if (empty($_POST['answer4']))
			{
				echo '<div class="center-title">Please Answer Question 4</div>';
				$formOK = false;
			}				
			if (empty($_POST['answer5']))
			{
				echo '<div class="center-title">Please Answer Question 5</div>';
				$formOK = false;
			}	
			if ($formOK == true)
			{		
			...
			{
				echo '<div class="center-title">Click <a href="javascript:history.go(-1)">HERE</a> to go back and adjust your entry.</div>';
			}
